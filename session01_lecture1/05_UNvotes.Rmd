...
Let's take a look at the voting ***history*** of countries in the
***United Nations General Assembly***. We will be using data from the
**unvotes** package. Additionally, we will make use of the **tidyverse**
and **lubridate** packages for the analysis, and the **DT** package for
...
un_votes %>%
  filter(country %in% c("United States", "Italy", "United Kingdom")) %>%
  inner_join(un_roll_calls, by = "rcid") %>%
